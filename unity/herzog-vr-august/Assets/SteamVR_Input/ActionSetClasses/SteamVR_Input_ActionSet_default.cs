...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean ToggleDebug
        {
            get
            {
                return SteamVR_Actions.default_ToggleDebug;
            }
        }
        ...
        public virtual SteamVR_Action_Boolean ToggleController
        {
            get
            {
                return SteamVR_Actions.default_ToggleController;
            }
        }
